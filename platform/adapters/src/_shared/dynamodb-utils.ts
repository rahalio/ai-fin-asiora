 ...
 *
 * @returns The core table name (e.g., "asiora-core-dev")
 ...
 *
 * @returns The base table name (e.g., "asiora-base-dev")
 ...
 *
 * @returns The analytics table name (e.g., "asiora-analytics-dev")
 ...
 *
 * @returns The realtime table name (e.g., "asiora-app-realtime-dev")
