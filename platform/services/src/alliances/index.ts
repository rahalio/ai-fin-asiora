/**
 * Alliances Services - Application Layer Export
 *
...
/**
 * Alliances Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for alliances domain.
 */
