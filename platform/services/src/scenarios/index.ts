/**
 * Scenarios Services - Application Layer Export
 *
...
/**
 * Scenarios Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for scenarios domain.
 */
