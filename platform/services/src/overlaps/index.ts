/**
 * Overlaps Services - Application Layer Export
 *
...
/**
 * Overlaps Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for overlaps domain.
 */
